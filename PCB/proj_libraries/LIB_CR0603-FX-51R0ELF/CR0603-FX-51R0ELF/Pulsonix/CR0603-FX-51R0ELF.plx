...
//1512068/983811/2.49/2/5/Resistor
...
(library Library_1
	...
	(symbolDef "CR0603-FX-51R0ELF" (originalName "CR0603-FX-51R0ELF")
	...
	(compDef "CR0603-FX-51R0ELF" (originalName "CR0603-FX-51R0ELF") (compHeader (numPins 2) (numParts 1) (refDesPrefix R)
		)
		(compPin "1" (pinName "1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "CR0603-FX-51R0ELF"))
		...
		(attr "Mouser Part Number" "652-CR0603FX-51R0ELF")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Bourns/CR0603-FX-51R0ELF/?qs=0nF2VnfAjXm8gQpP7vsFGw%3D%3D")
		(attr "Manufacturer_Name" "Bourns")
		(attr "Manufacturer_Part_Number" "CR0603-FX-51R0ELF")
		(attr "Description" "BOURNS - CR0603-FX-51R0ELF - RES, 51R, 1%, 0603, THICK FILM")
		(attr "<Hyperlink>" "https://www.bourns.com/pdfs/chpreztr.pdf")
		(attr "<Component Height>" "0.55")
		(attr "<STEP Filename>" "CR0603-FX-51R0ELF.stp")
