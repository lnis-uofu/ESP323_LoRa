...
//632138/983811/2.49/5/3/Connector
...
(library Library_1
	...
	(patternDef "RHDR5W70P0X254_1X5_1310X250X86" (originalName "RHDR5W70P0X254_1X5_1310X250X86")
		(multiLayer
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -1.72 1.5) (pt 12.23 1.5) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 12.23 1.5) (pt 12.23 -1.5) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 12.23 -1.5) (pt -1.72 -1.5) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.47 -1.25) (pt -1.47 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.47 1.25) (pt 11.98 1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 11.98 1.25) (pt 11.98 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 11.98 -1.25) (pt -1.47 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -1.25) (pt 11.98 -1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 11.98 -1.25) (pt 11.98 1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 11.98 1.25) (pt -1.47 1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -1.47 1.25) (pt -1.47 0) (width 0.2))
		)
	)
	(symbolDef "M20-7820542" (originalName "M20-7820542")
	...
	(compDef "M20-7820542" (originalName "M20-7820542") (compHeader (numPins 5) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "M20-7820542"))
		(attachedPattern (patternNum 1) (patternName "RHDR5W70P0X254_1X5_1310X250X86")
			(numPads 5)
			(padPinMap
		...
		(attr "Mouser Part Number" "855-M20-7820542")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Harwin/M20-7820542?qs=vF78I%252BjhbY9JoekBTXVWnQ%3D%3D")
		(attr "Manufacturer_Name" "Harwin")
		(attr "Manufacturer_Part_Number" "M20-7820542")
		(attr "Description" "Headers & Wire Housings 5 PIN SIL VERTICAL SOCKET GOLD+TIN")
		(attr "<Hyperlink>" "https://cdn.harwin.com/pdfs/M20-782.pdf")
		(attr "<Component Height>" "8.65")
		(attr "<STEP Filename>" "M20-7820542.stp")
